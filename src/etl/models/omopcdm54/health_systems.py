...
class CareSite(ModelBase):
    ...
    place_of_service_concept_id: Final[Column] = IntField(FK(Concept.concept_id))
...
class Provider(ModelBase):
    ...
    specialty_source_concept_id: Final[Column] = IntField(FK(Concept.concept_id))
